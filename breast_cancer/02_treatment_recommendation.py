...
rec_ij = deepsurvk.recommender_function(dsk, X_test1, 'RX Summ--Surg Prim Site')

recommendation_idx, _ = deepsurvk.get_recs_antirecs_index(rec_ij, X_test, 'RX Summ--Surg Prim Site')

Y_test_original = Y_test1.copy(deep=True)
Y_test_original['Number of Intervals (Calculated)'] = Y_scaler.inverse_transform(Y_test1)
E_test1 = Utils.map_one_col_data(E_test1, "End Calc Vital Status (Adjusted)", br_utils.map_event_code)
deepsurvk.plot_km_recs_antirecs(Y_test_original, E_test1, recommendation_idx)
